...
int main() {
    ...
    PlanetProperties sun(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(0.0f),
                     0.00465f, 1.0f, glm::vec3(1,0.5,0), "Sun"); // radius, mass

    PlanetProperties mercury(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(0.0f),
                            1.63e-5f, 1.66e-7f, glm::vec3(0.5,0.5,0.5), "Mercury");

    PlanetProperties venus(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(0.0f),
                        4.05e-5f, 2.45e-6f, glm::vec3(1,0.8,0.2), "Venus");

    PlanetProperties earth(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(0.0f),
                            4.26e-5f, 3.0e-6f, glm::vec3(0,0.5,1), "Earth");

    PlanetProperties mars(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(0.0f),
                        2.27e-5f, 3.21e-7f, glm::vec3(1,0,0), "Mars");

    PlanetProperties jupiter(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(0.0f),
                            0.000285f, 9.55e-4f, glm::vec3(1,0.5,0), "Jupiter");

    PlanetProperties saturn(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(0.0f),
                            0.000241f, 2.86e-4f, glm::vec3(1,1,0), "Saturn");

    PlanetProperties uranus(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(0.0f),
                            0.000103f, 4.37e-5f, glm::vec3(0,1,1), "Uranus");

    PlanetProperties neptune(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(0.0f),
    ...
    std::vector<PlanetProperties> planet1 = {sun, mercury};
    std::vector<PlanetProperties> planet2 = {sun, venus};
    std::vector<PlanetProperties> planet3 = {sun, earth};
    std::vector<PlanetProperties> planet4 = {sun, mars};
    std::vector<PlanetProperties> planet5 = {sun, jupiter};
    std::vector<PlanetProperties> planet6 = {sun, saturn};
    std::vector<PlanetProperties> planet7 = {sun, uranus};
    std::vector<PlanetProperties> planet8 = {sun, neptune};
